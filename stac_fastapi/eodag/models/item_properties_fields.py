...
class FieldsSarItemProperties(BaseModel):
    ...
    polarizations: Optional[list[str]] = Field(None, alias="polarizationMode") #TODO: EODAG split string by "," to get this list
    ...
    looks_equivalent_number: Optional[float] = Field(None, alias="looks_equivalent_number")
...
class FieldsSatelliteItemProperties(BaseModel):
    ...
    """
    platform_international_designator: Optional[str] = Field(None, alias="platform_international_designator")
...
class FieldsItemProperties(BaseFieldsItemProperties):
    ...
    start_datetime: Optional[dt] = Field(None, alias="startTimeFromAscendingNode") # TODO do not set if start = end
    end_datetime: Optional[dt] = Field(None, alias="completionTimeFromAscendingNode") # TODO do not set if start = end
    ...
    instruments: Optional[list[str]] = Field(None, alias="instruments") #TODO EODAG has instrument a string with "," separated instruments
